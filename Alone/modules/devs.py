...
from Alone import app, OWNER
from Alone import app
from Alone.config import OWNER_ID, BOT_NAME
from Alone.database.chats import blacklist_chat, blacklisted_chats, whitelist_chat
from Alone.utils.decorators import sudo_users_only
from Alone.utils.filters import command
from Alone.modules import check_heroku
from Alone.utils.decorators import errors
from Alone.database.functions import start_restart_stage
...
async def update(_, message: Message):
    ...
    if str(m[0]) != "A":
        ...
        os.execvp("python3", ["python3", "-m", "Alone"])
    else:
        await message.reply_text("Bot is already in the **up-to-date** mode**", disable_web_page_preview=True)
