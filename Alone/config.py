...
OWNER_ID = int(getenv("OWNER_ID", "1891633746"))
UPDATE = getenv("UPDATE", "ThanimaiBots")
SUPPORT = getenv("SUPPORT", "ThanimaiSupport")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "999"))
CMD_MUSIC = list(getenv("CMD_MUSIC", "/ !").split())
BG_IMG = getenv("BG_IMG")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5259108841").split()))
